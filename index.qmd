...
econ_animate <- ggplot(econ_merged_data, aes(x = long, y = lat, group = group)) +
  ...
  scale_fill_gradient(name = "Income", low = "white", high = "darkblue", na.value = "grey", guide = "legend") +
  theme_void() +
...
abortion_animate <- ggplot(abortion_merged_data, aes(x = long, y = lat, group = group)) +
  ...
  scale_fill_gradient(name = "Abortions per 1000 Women", low = "white", high = "darkgreen", na.value = "grey", guide = "legend") +
  theme_void() +
...
election_animate <- ggplot(election_merged_data, aes(x = long, y = lat, group = group)) +
  ...
  scale_fill_gradient(name = "% of Vote", low = "white", high = "darkred", na.value = "grey", guide = "legend") +
  theme_void() +
...
abortion_animate <- ggplot(state_migration_merged_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = `Different state of residence 1 year ago: Estimate`)) +
  scale_fill_gradient(name = "# of Newcomers", low = "white", high = "darkgreen", na.value = "grey", guide = "legend") +
  theme_void() +
  labs(subtitle = "Estimated number of people who lived in a different state the previous year over time", caption = "Source: Census") +
  transition_states(Year) +
  labs(title = "Year: {closest_state}") + 
  theme(plot.title = element_text(hjust = 0.5))  
...
```{r}
ggplot(data = all_variables_dataset, 
       aes(x = `Different state of residence 1 year ago: Estimate`, 
           y =`Median Household Income`, 
           color = political_culture))+
geom_point()+
geom_smooth(method = "lm", se=F)+
coord_flip(ylim = c(40000,120000), xlim = c(25000, 700000))
```
