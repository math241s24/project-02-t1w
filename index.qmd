...
state_migration_merged_data <- merge(state_migration_map_data, state_migration_data, by.x = "region", by.y = "Current residence in", all.x = TRUE)
...
abortion_animate <- ggplot(state_migration_merged_data, aes(x = long, y = lat, group = group)) +
  ...
  scale_fill_gradient(name = "# of Newcomers", low = "lightgreen", high = "darkgreen", na.value = "grey", guide = "legend") +
  theme_void() +
