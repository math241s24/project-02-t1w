...
abortion_animate <- ggplot(state_migration_merged_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = `Different state of residence 1 year ago: Estimate`), na.rm = TRUE) +
  scale_fill_gradient(name = "# of Newcomers", low = "lavender", high = "violet", na.value = "grey", guide = "legend") +
  theme_void() +
